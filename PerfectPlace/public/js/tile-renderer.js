(function(window) {
	...
	function updateParameters (paramsList) {
	...
	function generateViewportCanvas(tiles, actZoom, finalCallback, callback) {
	    ...
	    for (var row = 0; row < actRows; row++) {
	    	for (var col = 0; col < actCols; col++) {
		    	...
		    	tileImg.src = "http://localhost:8000/maps/" + category + "/" + actZoom + "/" + tile[0] + "/" + tile[1] + "/tile.png";
	...
	window.TileRenderer.updateParameters = updateParameters;
